...
class FeaturesDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        super().__init__()
        self.movie_title_embeddings = movie_title_embeddings
    ...
    def from_pandas(
        ...
        return cls(
            movie_title_embeddings=movie_features["title_embedding"].to_numpy(),
    ...
    def __getitem__(self, idx: int) -> dict[str, torch.Tensor]:
        ...
        """
        mov_title = self.movie_title_embeddings[idx]
        mov_genres = self.movie_genres[idx]  # Collection of dummy variables
        mov_release_year = self.movie_release_years[idx]
        user_genre_avg = self.user_genre_avgs[idx]  # Collection of dummy variables
